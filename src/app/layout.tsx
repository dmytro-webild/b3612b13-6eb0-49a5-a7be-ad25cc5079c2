...
export const metadata: Metadata = {
  title: "Florida Elite Moving | Sarasota Moving Company | 24/7 Service",  description: "Professional moving services in Sarasota County. 10+ years experience, 5-star rated, transparent pricing. Local, long-distance, and specialty moves. Call 941-586-9329 today!",  keywords: "Sarasota moving company, professional movers, local moving, long-distance moving, furniture moving, moving services, Sarasota relocation",  metadataBase: new URL("https://floridaelitemoving.com"),
  alternates: {
    canonical: "https://floridaelitemoving.com"},
  openGraph: {
    title: "Florida Elite Moving | Professional Movers in Sarasota",    description: "Trusted moving company with 10+ years experience. 5-star rated service, transparent pricing, 24/7 availability. Get your free quote today!",    url: "https://floridaelitemoving.com",    siteName: "Florida Elite Moving",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/woman-takeout-employee-delivering-boxes-pizza-building-driving-delivery-car_482257-134975.jpg",        alt: "Florida Elite Moving - Professional moving service"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Florida Elite Moving | Sarasota's Trusted Moving Company",    description: "Professional movers with 10+ years experience. 5-star rated, transparent pricing, 24/7 service. Get your free moving quote now!",    images: ["http://img.b2bpic.net/free-photo/woman-takeout-employee-delivering-boxes-pizza-building-driving-delivery-car_482257-134975.jpg"],
  },
  robots: {
    index: true,
    follow: true,
